...
# ---------------- Argument Parsing ---------------- #
def parse_args():
    parser = argparse.ArgumentParser(description="Seq2SeqAttention Training for Dakshina Transliteration")
    ...
    parser.add_argument('--attention', type=bool, default=True, help='Use attention mechanism')
